...
const portParameter = 8081 //Asignamos un puerto para que se levante el sevidor
...
app.use("/clientes",EndPoints) //Creamos la url para el llamado de las uris

mongoose.connect( //Establecemos conexion
    "mongodb+srv://admin:admin@cluster0.4o9i9.mongodb.net/CLIENTES?retryWrites=true&w=majority", //pegamos el link de la base de datos
